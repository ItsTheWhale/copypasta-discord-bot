...
${name} Linux uses a "rolling release" system which allows one-time installation and perpetual software upgrades. It is not generally necessary to reinstall or upgrade your ${name} Linux system from one "version" to the next. By issuing one command, an ${name} system is kept up-to-date and on the bleeding edge.`.slice(0, 2000)
        });
    },
